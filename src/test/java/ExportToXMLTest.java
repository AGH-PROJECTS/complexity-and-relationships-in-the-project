...
public class ExportToXMLTest {
    ...
    public void exportToXML_ThrowNullPointerException() {
        ...
        exportToXML.exportGraphToXML(null, null, null);
    }
    ...
    public void exportToXML_NotThrowNullPointerException() {
        ...
        ExportToXML exportToXML = new ExportToXML();
        exportToXML.exportGraphToXML(dataRelationsList, dataWeightsList, "name");
    }

    @Test(expected = NullPointerException.class)
    public void exportToXML1_ThrowNullPointerException() {
        ExportToXML exportToXML = new ExportToXML();
        exportToXML.exportGraphToXML(null, "name");
    }

    @Test
    public void exportToXML1_NotThrowNullPointerException() {
        ExportToXML exportToXML = new ExportToXML();
        exportToXML.exportGraphToXML(gen.getFilesMethodsDependency(), "name");
    }
}